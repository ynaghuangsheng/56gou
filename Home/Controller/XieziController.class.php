<?php
class XieziController extends Controller {
    //列表
	public function index(){
        ...
        //模板赋值
		$this->assign('index','xiezi');//设置导航游标
	...
	public function tag(){
        ...
        $url='/xiezi/'.urlencode($tag).'/';//设置默认Url
	    $where="`cid`=2 and `title` like '%{$tag}%'";//设置查询条件
	    //设置头部信息
