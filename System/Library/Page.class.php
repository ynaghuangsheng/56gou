...
class Page{
    ...
    public function __construct($data = array()){
           ...
           $this->list_rows = !empty($data['list_rows'])?$data['list_rows']:40;//页显示行数
           $this->now_page =  !empty($data['now_page'])?intval($data['now_page']):1; //当前页码
           $this->url= !empty($data['url'])?$data['url']:'';//url  {page}页码替换标签
